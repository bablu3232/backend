...
function AdminDashboardPage({ onNavigate }) {
    ...
    React.useEffect(() => {
        if (tab === 'overview' && stats && chartRef.current) {
            ...
            chartInstance.current = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: ['Users', 'Reports', 'Drugs', 'Parameters'],
                    datasets: [{
                        label: 'System Metrics',
                        data: [stats.total_users || 0, stats.total_reports || 0, stats.total_drugs || 0, stats.total_parameters || 0],
                        borderColor: '#0EA5E9',
